...
FAKE_VALUE_FUNC( int, compress_headers, headers_t *, uint8_t *, hpack_states_t *);
...
int receive_header_block_fake_custom(uint8_t *header_block, int size, headers_t *headers, hpack_states_t *hpack_states)
{
