...
#undef LOG_LEVEL_HTTP2_SEND
#define LOG_LEVEL_HTTP2_SEND (LOG_LEVEL_DEBUG)
#undef LOG_LEVEL_HTTP2_CHECK
#define LOG_LEVEL_HTTP2_CHECK (LOG_LEVEL_DEBUG)
#undef LOG_LEVEL_HTTP2_FLOWCONTROL
#define LOG_LEVEL_HTTP2_FLOWCONTROL (LOG_LEVEL_DEBUG)
#undef LOG_LEVEL_HTTP2_UTILS
#define LOG_LEVEL_HTTP2_UTILS (LOG_LEVEL_DEBUG)
#undef LOG_LEVEL_HTTP2_HANDLE
#define LOG_LEVEL_HTTP2_HANDLE (LOG_LEVEL_DEBUG)
