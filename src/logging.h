...
#define LOG_PRINT_CONTEXT(func, file, line)
#else
#define LEVEL (DEBUG)
#define LOG_PRINT_CONTEXT(func, file, line) LOG_PRINT("; at %s:%d in %s()", file, line, func)
#endif
...
#define LOG(level, func, file, line, msg, ...)                                                                       \
    ...
    {                                                                                                                \
        if (level >= LEVEL)                                                                                          \
        {                                                                                                            \
            LOG_PRINT("[" LEVEL_STR(level) "] " msg, ##__VA_ARGS__);                                                 \
            switch (level)                                                                                           \
            {                                                                                                        \
            case DEBUG:                                                                                              \
            case INFO:                                                                                               \
            case WARN:                                                                                               \
                LOG_PRINT_CONTEXT(func, file, line);                                                                 \
                LOG_PRINT("\n");                                                                                     \
                break;                                                                                               \
            case ERROR:                                                                                              \
            case FATAL:                                                                                              \
