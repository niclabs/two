 ...
 * The parameter settings_values expects an array of size 6 with the values for
 * the local settings in the order of their identifiers
 *
 * Return the actual number of bytes queued
 */
 ...
 *        -> stream_id: identifier of the stream or 0 if it is a connection
 * window update
